          ...
          <div className="absolute right-0 mt-2 w-64 rounded-md border border-gray-100 bg-white py-1 shadow-lg">
            ...
            <div className="px-2 py-1">
              <button
                ...
                className="flex w-full items-center rounded-md px-2 py-1 text-xs text-violet-600 hover:bg-gray-100"
              >
            ...
            <div className="px-2 py-1">
              <button
                ...
                className="flex w-full items-center rounded-md px-2 py-1 text-xs text-red-600 hover:bg-gray-100"
              >
